...
RSpec.describe Book, type: :model do
  subject do
    described_class.new(title: "harry potter", author: 'J.K Rowling', price: 5, published_date: DateTime.new(2001, 5, 3.5))
  ...
  it 'Test: Book should not be valid without all entries' do
    subject.title = nil
    subject.author = nil
    subject.price = nil
